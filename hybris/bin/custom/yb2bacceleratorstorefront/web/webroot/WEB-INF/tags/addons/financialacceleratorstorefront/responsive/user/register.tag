...
<form:form method="post" modelAttribute="FSRegisterForm" action="${action}">
	...
	<formElement:formInputBox idKey="register.dateOfBirth"
		labelKey="register.dateOfBirth" path="dateOfBirth" inputCSS="form-control js-calendar"
		mandatory="true" placeholder="global.date.format" autocomplete="off"/>
