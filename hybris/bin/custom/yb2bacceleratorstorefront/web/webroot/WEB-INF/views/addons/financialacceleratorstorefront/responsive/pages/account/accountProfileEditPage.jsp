    ...
    <div class="container-lg col-md-6">
        <div class="account-section-content">
            <div class="account-section-form">
                <form:form action="fs-update-profile" method="post" modelAttribute="updateProfileForm">
                    ...
                    <formElement:formInputBox idKey="profile.dateOfBirth" labelKey="profile.dateOfBirth" path="dateOfBirth" inputCSS="text js-calendar" mandatory="true" placeholder="global.date.format" autocomplete="off"/>
                    <div class="row">
