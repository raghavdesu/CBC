			...
			<form:form method="post" modelAttribute="paymentDetailsForm" class="create_update_payment_form">
                ...
                <div id="form_button_panel" class="form-actions">
                    <ycommerce:testId code="multicheckout_cancel_button">
                        <a class="button" href="${fn:escapeXml(previousStep)}"><spring:theme code="checkout.multi.quoteForm.back" text="Back"/></a>
                    </ycommerce:testId>
                    <c:if test="${not hasNoPaymentInfo}">
                        <a class="button" href="${fn:escapeXml(choosePaymentMethodUrl)}"><spring:theme code="checkout.multi.cancel" text="Cancel"/></a>
                    </c:if>
