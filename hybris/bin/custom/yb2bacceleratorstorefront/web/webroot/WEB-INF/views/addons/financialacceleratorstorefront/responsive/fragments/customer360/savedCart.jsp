...
<spring:url value="/my-account/my-financial-applications" var="myQuotesUrl" htmlEscape="false"/>
...
<c:choose>
  	<c:when test="${empty cart or empty cart.entries}">         
    	 <div class="asm__customer360-subheadline">
        	<spring:message code="text.customer360.overview.customer.savedQuotes" text="Saved Quotes"/>
   		 </div>
        	...
        	<div class="row">
                <div class="col-xs-12">
                    <div class="asm__customer360-overview-divider">
                      <spring:theme
                             code="text.customer360.overview.customer.savedQuotes.no"
	...
	<c:otherwise>
	   	<div class="asm__customer360-headline">
	        <spring:message code="text.customer360.overview.customer.savedQuotes"  text="Saved"/>&nbsp;<a href="${fn:escapeXml(myQuotesUrl)}">Quotes</a>
	                ...
	                <div class="col-sm-6 col-md-4 asm__customer360-overview-saved-box">
	                    <div class="asm__customer360-overview-saved">
	                        <div class="asm__customer360-overview-product-img">
	                            <a class="responsive-table-link text-nowrap">
	                                <product:productPrimaryImage product="${entry.product}" format="thumbnail"/>
	                            </a>
	                        </div>
	                        <div class="asm__customer360-overview-saved-text-wrap">
                                <div class="asm__customer360-overview-product-name">
                                    <a class="responsive-table-link text-nowrap" title="${fn:escapeXml(entry.product.name)}">
