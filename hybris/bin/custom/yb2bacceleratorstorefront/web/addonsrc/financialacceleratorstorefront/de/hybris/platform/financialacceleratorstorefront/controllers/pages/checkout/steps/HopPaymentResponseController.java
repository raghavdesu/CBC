...
public class HopPaymentResponseController extends PaymentMethodCheckoutStepController
{
	...
	public String doHandleHopResponse(final HttpServletRequest request)
	{
		...
		else
		{
			...
			return REDIRECT_URL_ERROR + "/?decision=" + paymentSubscriptionResultData
					.getDecision() + "&reasonCode=" + paymentSubscriptionResultData.getResultCode();
		}
	...
	public String doHostedOrderPageError(@RequestParam final String decision, @RequestParam final String reasonCode,
			final Model model, final RedirectAttributes redirectAttributes) throws CMSItemNotFoundException
	{
		String redirectUrl = REDIRECT_PREFIX + getRedirectAddPaymentInfoUrl();
