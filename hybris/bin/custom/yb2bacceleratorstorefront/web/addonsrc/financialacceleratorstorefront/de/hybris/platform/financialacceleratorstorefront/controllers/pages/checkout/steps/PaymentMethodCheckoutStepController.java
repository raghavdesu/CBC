...
{
	protected static final Map<String, String> cybersourceSopCardTypes = new HashMap<>();
	...
	@RequireHardLogIn
	public String add(final Model model, @Valid final PaymentDetailsForm paymentDetailsForm,
			...
			throws CMSItemNotFoundException
	{
		...
		else
		{
			...
			addressData = populateAddressDataFromAddressForm(addressForm);
		}
	...
	protected AddressData populateAddressDataFromAddressForm(final AddressForm addressForm)
	{
